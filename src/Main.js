            ...
            <div className="contentsMain">
                <div className="section1">
                    <div className="section-textarea">
                        ...
                        <p className="section1-subtitle">Electric Vehicle World MAP</p>
                ...
                <div className="section2">
                    <div className="section2-textarea">
                        <p className="section2-title">EV WMAP<span>SERVICE</span><span className="none">1</span></p>
                ...
                <div className="section3-media">
                    <div className="media-textarea">
                        <p className="media-title">EV WMAP<span>SERVICE</span><span className="none">2</span></p>
                        <p className="media-title2">충전소예약</p>
                        <p className="media-subtitle">빈 충전기 찾지 말고 원하는 충전기를 예약하여 사용하세요</p>
                    </div>
                </div>
                <div className="section3-media2">
                    <div className="media-textarea">
                        <p className="media-title">EV WMAP<span>SERVICE</span><span className="none">3</span></p>
                        <p className="media-title2">주변시설검색</p>
                        <p className="media-subtitle">충전하는 동안 시간을 보낼 수 있는 곳을 찾아보세요</p>
                    </div>
                </div>
                <div className="section3-media">
                    <div className="media-textarea">
                        <p className="media-title">EV WMAP<span>SERVICE</span><span className="none">4</span></p>
                        <p className="media-title2">커뮤니티</p>
                        <p className="media-subtitle">EV WMAP 이용자들과 다양한 의견을 교류하세요</p>
                    </div>
                </div>
                {/* section end */}
