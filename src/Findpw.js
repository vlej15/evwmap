    ...
    >
      <div className="banner">
        ...
        <p className="subtitle">
          아래 이메일 인증을 통해 비밀번호를 변경 하실 수 있습니다.
        </p>
      </div>
      <div className="form">
          ...
          <div className="form-input">
            <div className="form-id">
              ...
              {errors.userid && errors.userid.type === "required" && (
                <p className="notice">This field is required</p>
              )}
            ...
            <div className="form-pw1">
              <label for="">
                <p className="form-label">변경 비밀번호</p>
              </label>
              <input
                type="password"
                className="input-text"
            ...
            <div className="form-pw2">
              ...
              {errors.password_confirm &&
                errors.password_confirm.type === "validate" && (
                  <p className="notice">The passwords do not match</p>
                )}
              <input
                type="submit"
                className="btn-ct"
      ...
      <div className="find-id">
        <p className="btn-subtitle">
          아이디가 기억나지 않는다면?
          <Link to="findid">
            <a href="Find_id.js" onclick="" className="go-id">
              아이디 찾기 바로가기
              <FontAwesomeIcon
