...
function CardRegistration(props) {
  ...
  const onSubmit = () => {
    ...
    var config = {
      method: "post",
      url: "http://193.122.106.148:8081/api/my-card",
      headers: {
        Authorization: token,
              ...
              <fieldset class="fieldset-expiration">
                ...
                <div class="select">
                  ...
                  >
                    ...
                    <option value="22">{getdate + 1}</option>
                    <option value="23">{getdate + 2}</option>
                    <option value="24">{getdate + 3}</option>
                    <option value="25">{getdate + 4}</option>
                    <option value="26">{getdate + 5}</option>
                    <option value="27">{getdate + 6}</option>
                    <option value="28">{getdate + 7}</option>
                    <option value="29">{getdate + 8}</option>
                    <option value="30">{getdate + 9}</option>
                  </select>
                </div>
              </fieldset>
